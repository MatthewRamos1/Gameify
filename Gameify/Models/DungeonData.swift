...
struct DungeonList {
    ...
    static let dungeon1Enemies = [Enemy(name: "Slime", level: 1, currentHealth: 10, maxHealth: 10, strength: 1, constitution: 1, intelligence: 1, wisdom: 1, dexAgi: 1, charisma: 1, encounterChance: 50, goldDrop: 1, itemDrops: nil), Enemy(name: "Goblin", level: 2, currentHealth: 12, maxHealth: 12, strength: 2, constitution: 2, intelligence: 1, wisdom: 0, dexAgi: 4, charisma: 3, encounterChance: 50, goldDrop: 1, itemDrops: nil)]
    static let dungeon2Enemies = [Enemy(name: "Slime2", level: 1, currentHealth: 10, maxHealth: 10, strength: 1, constitution: 1, intelligence: 1, wisdom: 1, dexAgi: 1, charisma: 1, encounterChance: 50, goldDrop: 1, itemDrops: nil)]
    static let dungeonList = [dungeon1, dungeon2]
    
    static public func getEnemy(dungeon: Dungeon) -> Enemy {
        dungeon.enemies.first!
    }
}
